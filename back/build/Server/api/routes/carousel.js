...
const Update_1 = require("../controllers/carousel/Update");
const ReadById_1 = require("../controllers/carousel/ReadById");
...
app.post('/update', [Security_1.security_post,
    (0, express_validator_1.check)('id', 'El id del carosuel a actualizar es obligatorio').isNumeric(),
