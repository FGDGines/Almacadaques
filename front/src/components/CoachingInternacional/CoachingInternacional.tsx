...
const CoachingInternacional = () => {
    ...
    return <div className="CoachingInternacional">
        ...
        <div className="containerInternacional">
            ...
            <h3>{textos[languageFlag].textcoachinginternatitle9}</h3>
                <p className='parrafo'>{textos[languageFlag].textcoachinginterna9}</p>
                <p className='parrafo'>{textos[languageFlag].textcoachinginterna10}</p>
                <p className='parrafo'>{textos[languageFlag].textcoachinginterna11}</p>
