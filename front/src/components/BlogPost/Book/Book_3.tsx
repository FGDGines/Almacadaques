                    ...
                    <div className="demoPage" >
                        ...
                        <div className="marco">
                            <div className="titlePortal">
                                ...
                                <p>Cuando estoy presente con lo que estoy haciendo (por ejemplo lavando los platos, saboreando la comida, hablando con la vecina, leyendo, etc) no me dejo llevar por el futuro incierto y desconocido ni por la nostalgia del pasado.</p>
                    ...
                    <div className="demoPage" >
                        ...
                        <div className="marco">
                            <div className="titlePortal">
                                ...
                                <p>Cuando simplificas tus tareas diarias (evitando agendas llenas de actividades que no te aportan valor), estás presente, das lo mejor de ti y no te apegas a los resultados, te sentirás bien y dejarás de dar vueltas a los que podría ser.</p>
