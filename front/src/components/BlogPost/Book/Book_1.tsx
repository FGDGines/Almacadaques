      ...
      <div className="BookItem">
        ...
        >
            ...
            <div className="marco">
              ...
              <div className="imgLibro">
                ...
                <p>En función de a quien le preguntes la respuesta será una u otra.
                  Según los estoicos, la abundancia no se basa en la posesión de bienes materiales, sino en la virtud y vivir de acuerdo a la naturaleza. Para ellos, la verdadera abundancia está en tener una mente tranquila, estar en armonía con el universo y ser autosuficiente emocionalmente. Hay quien dice que la abundancia es un estado de plenitud y cercanía en todas las áreas de tu vida. Para mí, la abundancia me conecta con la felicidad. Cuando siento abundancia me siento feliz.</p>
          ...
          <div className="demoPage" >
            ...
            <div className="marco">
              <div className="titlePortal">
              <p>Y aquí quiero proponerte 5 claves para atraer a Abundancia.</p>
<h3>1. Llena tu mente de creencias positivas y expansivas</h3>
              ...
              <p>¿Sabías que la oportunidad está al otro lado del miedo? ¿Sabías que tus miedos esconden tu mayor potencial? </p>
          ...
          <div className="demoPage" >
            ...
            <div className="marco">
              <div className="titlePortal">
              <p>¿Sabías que el despliegue de tu potencial y tus dones son el camino a la abundancia Enfrentar nuestros miedos nos sitúa instantáneamente a la superación. Seguro que has experimentado más de una vez esa sensación después de haber conseguido algo que al principio te generaba temor. </p>
